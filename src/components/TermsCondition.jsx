  ...
  return (
    <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      ...
      <div className="flex flex-row gap-5 ">
        <h1 className="font-bold text-center text-3xl">📢Terms & Conditions📢</h1>
      </div>
        <div className=" flex flex-row gap-5">
          <div className="flex flex-col items-left gap-5 ">
            ...
            <h1 className=" font-semibold text-xl">🏷️50% Advance payment is mandatory while booking photoshoot slot.</h1>
            <h1 className=" font-semibold text-xl">🔖100% payment is mandatory before start of photoshoot.</h1>
            <h1 className=" font-semibold text-xl">🏷️Any damage to property or photoshoot set by customer or photographer should be compensated by them.</h1>
